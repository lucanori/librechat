...
- **Option 3: Discord Server**: You can join our [Discord community](https://discord.one-ring.ai) and initiate first contact in the `#issues` channel. However, please ensure that initial contact through Discord does not include any sensitive details.
...
We are committed to maintaining the security of our open-source project, one-ring, and promptly addressing any identified vulnerabilities. To ensure the security of our project, we adhere to the following practices:
...
- Repository: [one-ring](https://github.one-ring.ai)

## Contact

If you have any questions or concerns regarding the security of our project, please join our [Discord community](https://discord.one-ring.ai) and report them in the appropriate channel. You can also reach out to us by [opening an issue](https://github.com/lucanori/one-ring/issues/new) on GitHub. Please note that the response time may vary depending on the nature and severity of the inquiry.
